    ...
    <div class="card">
      <div class="card-content">
        <div class="card-body ">
          ...
          <span class="font-weight-bold ml-1" style="font-size: 20px; color:black;">
  {{ $review->is_anonymous ? 'Anonim' : getNameUser($review->user_id) }}
</span>
          ...
          <h3 style="font-weight: bold">Reviews</h3> <br>
            @foreach ($kamar->reviews as $review)
              <div class="mb-3">
                ...
                <span class="font-weight-bold ml-1" style="font-size: 20px; color:black;">{{ $review->is_anonymous ? 'Anonim' : getNameUser($review->user_id) }}</span>
